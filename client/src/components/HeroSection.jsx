			...
			<div style={{backgroundImage: `url(${bgImg})`}} className="pt-30 lg:pt-10 md:pt-20 bg-cover bg-center">
				<div
                    ...
                    <img
                        ...
                        className="aspect-[3/4] max-h-screen lg:max-w-lg md:max-w-md rounded-3xl object-cover order-first lg:order-last"
                    />


                    <div className="space-y-5 lg:pr-22">

                        {/* Badge / label — NOT a heading */}
                        <div className="flex items-center justify-center gap-3 bg-slate-900 p-2 rounded-3xl w-fit shadow-lg border border-slate-700">
                            <span className="w-3.5 h-3.5 bg-slate-100 rounded-full shadow-sm animate-pulse"></span>
                            <span className="text-slate-100 font-medium tracking-wider">
    Welcome to my universe
  </span>
                        </div>

                        {/* Optional intro text — NOT a heading */}
                        <p className="text-4xl font-semibold uppercase">Hello</p>

                        {/* Main page heading */}
                        <h1 className="text-4xl font-bold">
                            I'm Delowar Hossain Walid
                        </h1>

                        {/* Subtitle / role */}
                        <h2 className="text-3xl font-bold">    A{" "}        <span className="bg-gradient-to-r from-sky-400 to-blue-600 bg-clip-text text-transparent">
