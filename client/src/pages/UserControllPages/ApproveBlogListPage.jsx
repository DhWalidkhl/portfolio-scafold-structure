...
const ApproveBlogListPage = () => {
    ...
    let {ApprovedBlogList, ApprovedBlogListRequest, ApproveBlogListByUser, ApproveBlogListRequestByUser} = BlogStore()
    ...
    }, [ApprovedBlogListRequest, ApproveBlogListRequestByUser, isLogin, loading]);
        ...
        isLogin() ? (
            <BlogListLayout>
                <div className="flex justify-between items-center my-5">
                    {
                        userRole === "admin" ? (
                            <h1 className="text-xl font-semibold">Total Blogs : {ApprovedBlogList.length}</h1>) : (
                            <h1 className="text-xl font-semibold">Total Blogs : {ApproveBlogListByUser.length}</h1>)
                    }
